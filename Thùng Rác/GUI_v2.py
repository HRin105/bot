...
def main_gui():
    ...
    # Sau khi cược (s)
    ctk.CTkLabel(section_delay, text="Sau khi cược (s):", anchor="w", font=("Arial", 12),
                text_color="#d3d7de", fg_color="transparent").pack(fill="x", padx=12, pady=(0,0))
    entry_bet = ctk.CTkEntry(section_delay, width=80, font=("Arial",12),
                            fg_color="#181a1b", text_color="#d3d7de",
                            border_color="#1aafff", border_width=2)
    entry_bet.insert(0, "28")
    entry_bet.pack(fill="x", padx=12, pady=(0,0))
    widgets["var_delay_bet"] = entry_bet

    # Sau khi thắng chờ (s)
    ctk.CTkLabel(section_delay, text="Sau khi thắng chờ (s):", anchor="w", font=("Arial", 12),
                text_color="#d3d7de", fg_color="transparent").pack(fill="x", padx=12, pady=(0,0))
    entry_win = ctk.CTkEntry(section_delay, width=80, font=("Arial",12),
                            fg_color="#181a1b", text_color="#d3d7de",
                            border_color="#1aafff", border_width=2)
    entry_win.insert(0, "24")
    entry_win.pack(fill="x", padx=12, pady=(0,6))
